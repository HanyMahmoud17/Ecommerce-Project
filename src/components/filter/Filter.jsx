...
function Filter() {
  ...
  // Get unique category and price values from the product data
      ...
      >
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button
            ...
            className="px-4 py-2 text-white bg-pink-600 hover:bg-pink-500 hover:text-white text-sm font-medium rounded-md"
            style={{ backgroundColor: mode === 'dark' ? 'rgb(64 66 70)' : '', color: mode === 'dark' ? 'white' : '' }}
          >
            Reset Filter
          </button>
