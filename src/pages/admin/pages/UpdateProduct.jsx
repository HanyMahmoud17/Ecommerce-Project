                    ...
                    <div className="md:mt-0 sm:mt-40">
                        <div className='flex justify-center items-center h-screen'>
                            <div className=' bg-gray-800 px-10 rounded-xl'>
                                ...
                                <div>
                                <label htmlFor="name" className="block text-base font-bold text-white">Title</label>
                                    <input type="text"
                                ...
                                <div>
                                <label htmlFor="name" className="block text-base font-bold text-white">Price</label>
                                    <input type="text"
                                        name='price'
                                ...
                                <div>
                                <label htmlFor="name" className="block text-base font-bold text-white">Image Url</label>
                                    <input type="text"
                                        name='imageurl'
                                ...
                                <div>
                                <label htmlFor="name" className="block text-base font-bold text-white">Category</label>
                                    <input type="text"
                                        name='category'
                                ...
                                <div>
                                <label htmlFor="name" className="block text-base font-bold text-white">Description</label>
